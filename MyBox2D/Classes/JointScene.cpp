...
void JointScene::setupRevoluteJoint() {
	...
	b2PolygonShape rectShape;
	b2FixtureDef  fixtureDef;
	fixtureDef.shape = &rectShape;											// rectShape 的四個端點, 0 右上、 1 左上、 2 左下 3 右下
	Point lep[4], wep[4];
	...
	modelMatrix.m[3] = 0; //設定 Translation，自己的加上父親的
	modelMatrix.m[7] = 0; //設定 Translation，自己的加上父親的
